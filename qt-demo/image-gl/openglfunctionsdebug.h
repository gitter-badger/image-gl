#ifndef OPENGLFUNCTIONSDEBUG_H
#define OPENGLFUNCTIONSDEBUG_H

#include <QOpenGLFunctions>

class QOpenGLContext;
class OpenGLFunctionsDebug : public QOpenGLFunctions
{
public:
    OpenGLFunctionsDebug();
    OpenGLFunctionsDebug(QOpenGLContext * context);
    ~OpenGLFunctionsDebug();
