...
QT_MOC_LITERAL(5, 37, 3)
    ...
    "ImageGrid\0tileImageLoaded\0\0index\0row\0"
    "col"
};
...
void ImageGrid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->tileImageLoaded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (ImageGrid::*_t)(int , int , int );
...
// SIGNAL 0
void ImageGrid::tileImageLoaded(int _t1, int _t2, int _t3)
{
